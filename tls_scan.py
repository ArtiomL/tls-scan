...
def funArgParser():
	...
	objArgParser.add_argument('-j', help ='return full assessment JSON (default: grades only), disables -m', action = 'store_true', dest = 'json')
	objArgParser.add_argument('-l', help ='set log level (default: 0)', choices = [0, 1, 2, 3], type = int, dest = 'log')
	objArgParser.add_argument('-m', help ='mail report', action = 'store_true', dest = 'mail')
